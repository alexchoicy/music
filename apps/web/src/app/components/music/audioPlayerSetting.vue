    ...
    <Sheet>
        ...
        <SheetContent>
            <SheetHeader class="border-b-2">
                ...
                <SheetDescription>
                    Adjust your audio playback preferences.
                </SheetDescription>
            </SheetHeader>
            <div class="flex p-3 flex-col">
                <div>
                    ...
                    <RadioGroup v-model="qualityOptions">
                        <Item variant="outline" class="hover:cursor-pointer hover:bg-accent dark:hover:bg-accent/50"
                        ...
                        <Item variant="outline" class="hover:cursor-pointer hover:bg-accent dark:hover:bg-accent/50"
                            ...
                            <ItemContent>
                                ...
                                <ItemDescription>
                                    Encoded to Opus 112 kbps.
                                    High Quality but low bandwidth usage.
                                </ItemDescription>
                            </ItemContent>
                            <ItemActions>
