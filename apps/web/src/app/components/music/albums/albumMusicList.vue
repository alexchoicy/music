      ...
      <div v-for="disc in album.Disc" :key="disc.discNo">
        ...
        <div class="space-y-1">
          <div
            ...
            <Button
              variant="ghost"
              class="w-8 hidden group-hover:inline-flex"
            ...
            <Button
              ...
              @click="
                props.onClickDownloadTrack(
                  track.quality[0]!.url,
                  `${disc.discNo}-${track.trackNo} ${track.name}. ${getMusicExt(track.quality[0]!.fileContainer, track.quality[0]!.fileCodec)}`,
                )
              ">
