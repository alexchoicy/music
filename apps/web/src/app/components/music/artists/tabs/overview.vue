  ...
  <div class="w-full h-full pt-2">
    ...
    <div v-if="albumOnly.length > 0" class="mt-8 w-full">
      ...
      <div class="flex flex-row justify-center gap-4 flex-wrap overflow-hidden p-3 h-[410px]">
        <MusicAlbumsAlbumCard v-for="album in albumOnly" :key="album.id" :album="album" class="h-[385px] w-[250px]" />
      </div>
    </div>
    <div v-if="singleOnly.length > 0" class="mt-8 w-full">
      ...
      <div class="flex flex-row justify-center gap-4 flex-wrap overflow-hidden p-3 h-[410px]">
        <MusicAlbumsAlbumCard v-for="album in singleOnly" :key="album.id" :album="album" class="h-[385px] w-[250px]" />
      </div>
    </div>
    ...
    <div v-if="featuredInOnly.length > 0" class="mt-8 w-full">
      ...
      <div class="flex flex-row justify-center gap-4 flex-wrap overflow-hidden p-3 h-[410px]">
        <MusicAlbumsAlbumCard
          v-for="album in featuredInOnly"
          :key="album.id"
          :album="album"
