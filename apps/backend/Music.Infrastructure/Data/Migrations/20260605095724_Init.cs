        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AlbumImages_AlbumDiscs_AlbumDiscId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AlbumImages_AlbumDiscId",
                table: "AlbumImages",
                column: "AlbumDiscId"
            );

            migrationBuilder.CreateIndex(
                name: "IX_AlbumImages_AlbumDiscId_ImageRole",
                table: "AlbumImages",
                columns: new[] { "AlbumDiscId", "ImageRole" },
                unique: true,
                filter: "\"IsPrimary\" = true AND \"AlbumDiscId\" IS NOT NULL"
            );
            ...
            migrationBuilder.CreateIndex(
                ...
                unique: true,
                filter: "\"IsPrimary\" = true AND \"AlbumDiscId\" IS NULL"
            );
            ...
            migrationBuilder.CreateIndex(name: "IX_Parties_Kind", table: "Parties", column: "Kind");
