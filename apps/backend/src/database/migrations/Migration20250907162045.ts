...
export class Migration20250907162045 extends Migration {
  ...
  override async up(): Promise<void> {
    ...
    this.addSql(`create table "artists" ("id" bigserial primary key, "name" text not null, "language_id" bigint null, "artist_type" text check ("artist_type" in ('person', 'group', 'project')) not null, "created_at" timestamp(6) not null default now(), "updated_at" timestamp(6) not null default now());`);
    ...
    this.addSql(`create table "tracks" ("id" bigserial primary key, "name" text not null, "hash" text not null, "duration_ms" int not null, "file_type" text not null, "is_instrumental" boolean not null default false, "language_id" bigint null, "bitrate" int null, "sample_rate" int null, "musicbrainz_track_id" uuid null, "upload_status" smallint not null, "created_at" timestamp(6) not null default now(), "updated_at" timestamp(6) not null default now());`);
